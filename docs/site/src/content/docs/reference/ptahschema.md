...
| `spec.desired.transport` | `object` | This resource requires: where `desired.transport` is set, desired.transport.caFrom must name a required ConfigMap key. Transport is how the registry is reached: plain HTTP, a custom CA, a client certificate. |
...
| `spec.desired.transport.caFrom.key` | `string`, required | This resource requires: where `desired.transport` and `desired.transport.caFrom` are set, desired.transport.caFrom must name a required ConfigMap key. The key to select. |
...
| `spec.desired.transport.caFrom.optional` | `boolean` | This resource requires: where `desired.transport`, `desired.transport.caFrom` and `desired.transport.caFrom.optional` are set, desired.transport.caFrom must name a required ConfigMap key. Specify whether the ConfigMap or its key must be defined |
...
| `spec.desired.verificationPolicyFrom.optional` | `boolean` | This resource requires: where `desired.verificationPolicyFrom.optional` is set, desired.verificationPolicyFrom must name a required ConfigMap key. Specify whether the ConfigMap or its key must be defined |
...
| `spec.dev.urlFrom.optional` | `boolean` | This resource requires: where `dev` and `dev.urlFrom.optional` are set, dev.urlFrom must name a required Secret key. Specify whether the Secret or its key must be defined |
