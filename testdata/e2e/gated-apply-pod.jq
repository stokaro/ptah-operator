...
# and holding on that reading would carry the claim past its window for a
# reason that has nothing to do with the gate: the row would pass with the node
# selector no longer reaching the Pod at all.
#
