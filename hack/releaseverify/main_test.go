...
func TestVerifyWorkflowRejectsCriticalMutations(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"preflight timeout":         {`    timeout-minutes: 260`, `    timeout-minutes: 1`, false},
		"support poll timeout":      {`SUPPORT_POLL_TIMEOUT_MINUTES: "250"`, `SUPPORT_POLL_TIMEOUT_MINUTES: "100"`, false},
