...
func buildTeardownAuthorizationChecks(
	...
	appendResource(teardownCheckController, "update PtahMigration finalizer", "operator.ptah.run", "v1alpha1", "ptahmigrations", "finalizers", rollout.ReleaseNamespace, "update", arbitraryObjectName)
	...
	appendResource(teardownCheckController, "create PtahMigrationPlan", "operator.ptah.run", "v1alpha1", "ptahmigrationplans", "", rollout.ReleaseNamespace, "create", arbitraryObjectName)
